# TODO : Au lieu de faire le comparatif sur les données en cuors de test,
# Faire une demande API avec tout le jeu de train
# Choper le dataset avec les prédictions et les shap values
# Afficher les shap values pour un client donné, et sa position dans la distribution des probabilités de défaut
# Sa position aussi sur les 3 top features SHAP ou scatter sur les 2 TOP features
...
# ─────────────────────────────────────────────
# Row 3 — Distribution probabilités
# ─────────────────────────────────────────────
