...
MODEL = "lgb"  # LightGBM uniquement (SHAP non supporté sur XGBoost)
...
if df_train is not None and "proba" in df_train.columns and "predicted_label" in df_train.columns:
    ...
    if shap_values and len(train_shap_cols) >= 2:
        # Top 2 features du client courant (par valeur absolue)
        ...
        # Vérifier que ces colonnes shap existent dans le training set
